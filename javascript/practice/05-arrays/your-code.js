...
function combine(array1, array2) {
    return array1.concat(array2).toString();
}
...
// The function should NOT alter either parameter.
// Write your code here:
function subtractArray(originalArray, arrayToSubstract) {
    return originalArray.filter(e => !arrayToSubstract.includes(e)).toString();
}
